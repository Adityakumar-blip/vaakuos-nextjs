    ...
    <div className="fixed bottom-4 right-4 p-4 bg-white border border-gray-200 rounded-lg shadow-lg z-50 max-w-sm">
      ...
      <div className="space-y-1 mb-4 text-sm">
        <div className="flex justify-between">
          ...
          <span
            className={
              status.google ? "text-green-600 font-bold" : "text-red-500"
            }
          >
        ...
        <div className="flex justify-between">
          ...
          <span
            className={
              status.clarity ? "text-green-600 font-bold" : "text-red-500"
            }
          >
        ...
        <div className="flex justify-between">
          ...
          <span
            className={
              status.mixpanel ? "text-green-600 font-bold" : "text-red-500"
            }
          >
